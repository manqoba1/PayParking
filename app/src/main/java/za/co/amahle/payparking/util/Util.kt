...
import za.co.amahle.payparking.model.*
...
//    }
    ...
    @JvmStatic
    fun createDisplayChangeOfDenominations(saMonies: List<SAMoney?>): List<Int> {
        val drawables: MutableList<Int> = ArrayList()
        for (saMoney in saMonies) {

            if (saMoney!!.denomination == SAMoney.TWO_HUNDRED_RAND.denomination) {
                drawables.add(R.drawable.r200)
            } else if (saMoney.denomination == SAMoney.ONE_HUNDRED_RAND.denomination) {
                drawables.add(R.drawable.r100)
            } else if (saMoney.denomination == SAMoney.FIFTY_RAND.denomination) {
                drawables.add(R.drawable.r50)
            } else if (saMoney.denomination == SAMoney.TWENTY_RAND.denomination) {
                drawables.add(R.drawable.r20)
            } else if (saMoney.denomination == SAMoney.TEN_RAND.denomination) {
                drawables.add(R.drawable.r10)
            } else if (saMoney.denomination == SAMoney.FIVE_RAND.denomination) {
                drawables.add(R.drawable.r5)
            } else if (saMoney.denomination == SAMoney.TWO_RAND.denomination) {
                drawables.add(R.drawable.r2)
            } else if (saMoney.denomination == SAMoney.ONE_RAND.denomination) {
                drawables.add(R.drawable.r1)
            } else if (saMoney.denomination == SAMoney.FIFTY_CENT.denomination) {
                drawables.add(R.drawable.c50)
            } else if (saMoney.denomination == SAMoney.TWENTY_CENT.denomination) {
                drawables.add(R.drawable.c20)
            } else if (saMoney.denomination == SAMoney.TEN_CENT.denomination) {
                drawables.add(R.drawable.c10)
            } else if (saMoney.denomination == SAMoney.FIVE_CENT.denomination) {
                drawables.add(R.drawable.c5)
            } else if (saMoney.denomination == SAMoney.TWO_CENT.denomination) {
                drawables.add(R.drawable.c2)
            } else if (saMoney.denomination == SAMoney.ONE_CENT.denomination) {
                drawables.add(R.drawable.c1)
            }
...
//    }
    ...
    @JvmStatic
    fun breakingDownChangeIntoDenomination(paymentAmount: Double, amountPayable: Double): List<SAMoney?> {
        var changes: MutableList<SAMoney?> = Collections.EMPTY_LIST as MutableList<SAMoney?>
        changes = ArrayList()
        var balance = round(paymentAmount - amountPayable)
        while (balance > 0.00) {

            if (balance >= SAMoney.TWO_HUNDRED_RAND.denomination) {
                changes.add(SAMoney.TWO_HUNDRED_RAND)
                balance = round(balance - SAMoney.TWO_HUNDRED_RAND.denomination)
                continue
            } else if (balance >= SAMoney.ONE_HUNDRED_RAND.denomination) {
                changes.add(SAMoney.ONE_HUNDRED_RAND)
                balance = round(balance - SAMoney.ONE_HUNDRED_RAND.denomination)
                continue
            } else if (balance >= SAMoney.FIFTY_RAND.denomination) {
                changes.add(SAMoney.FIFTY_RAND)
                balance = round(balance - SAMoney.FIFTY_RAND.denomination)
                continue
            } else if (balance >= SAMoney.TWENTY_RAND.denomination) {
                changes.add(SAMoney.TWENTY_RAND)
                balance = round(balance - SAMoney.TWENTY_RAND.denomination)
                continue
            } else if (balance >= SAMoney.TEN_RAND.denomination) {
                changes.add(SAMoney.TEN_RAND)
                balance = round(balance - SAMoney.TEN_RAND.denomination)
                continue
            } else if (balance >= SAMoney.FIVE_RAND.denomination) {
                changes.add(SAMoney.FIVE_RAND)
                balance = round(balance - SAMoney.FIVE_RAND.denomination)
                continue
            } else if (balance >= SAMoney.TWO_RAND.denomination) {
                changes.add(SAMoney.TWO_RAND)
                balance = round(balance - SAMoney.TWO_RAND.denomination)
                continue
            } else if (balance >= SAMoney.ONE_RAND.denomination) {
                changes.add(SAMoney.ONE_RAND)
                balance = round(balance - SAMoney.ONE_RAND.denomination)
                continue
            } else if (balance >= SAMoney.FIFTY_CENT.denomination) {
                changes.add(SAMoney.FIFTY_CENT)
                balance = round(balance - SAMoney.FIFTY_CENT.denomination)
                continue
            } else if (balance >= SAMoney.TWENTY_CENT.denomination) {
                changes.add(SAMoney.TWENTY_CENT)
                balance = round(balance - SAMoney.TWENTY_CENT.denomination)
                continue
            } else if (balance >= SAMoney.TEN_CENT.denomination) {
                changes.add(SAMoney.TEN_CENT)
                balance = round(balance - SAMoney.TEN_CENT.denomination)
                continue
            } else if (balance >= SAMoney.FIVE_CENT.denomination) {
                changes.add(SAMoney.FIVE_CENT)
                balance = round(balance - SAMoney.FIVE_CENT.denomination)
                continue
            } else if (balance >= SAMoney.TWO_CENT.denomination) {
                changes.add(SAMoney.TWO_CENT)
                balance = round(balance - SAMoney.TWO_CENT.denomination)
                continue
            } else if (balance >= SAMoney.ONE_CENT.denomination) {
                changes.add(SAMoney.ONE_CENT)
                balance = round(balance - SAMoney.ONE_CENT.denomination)
                continue
            }
        }
        return changes
